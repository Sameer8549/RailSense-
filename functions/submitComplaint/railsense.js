...
function toClientComplaint(row, history) {
  ...
  return {
    ...
    pnr: row.pnr || null,
    ticketType: row.ticketType || row.ticket_type || "RESERVED",
    ticket_type: row.ticket_type || row.ticketType || "RESERVED",
    identifier_number: row.identifier_number || row.utsNumber || null,
    utsNumber: row.utsNumber || row.identifier_number || null,
    coachZone: row.coachZone || row.coach_zone || null,
